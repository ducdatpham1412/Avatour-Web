const HeartFillIcon = ({ className, color = '#110B0B', size = 28 }: BaseIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
