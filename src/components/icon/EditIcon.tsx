const EditIcon: React.FC<BaseIconProps> = ({ className }) => (
  <svg width="1em" height="1em" className={className} viewBox="0 0 24 24" fill="none">
    ...
    ></path>
    <path
      d="M16 3.5652L19.75 7.3152M21.4813 5.54645C21.9736 5.05414 22.2501 4.38643 22.2501 3.6902C22.2501 2.99397 21.9736 2.32626 21.4813 1.83395C20.9889 1.34164 20.3212 1.06506 19.625 1.06506C18.9288 1.06506 18.2611 1.34164 17.7688 1.83395L7.25 12.3152V16.0652H11L21.4813 5.54645V5.54645Z"
      stroke="#9A9A9A"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
