  ...
  return (
    <>
      <div className="sticky top-3 left-0">
        ...
        <button
          className="!h-[42px] !w-full !rounded-[42px] !font-bold bg-white border-[1px] border-[#9A9A9A] mt-[40px]"
          onClick={() => {
        ...
        <button
          className="!h-[42px] !w-full !rounded-[42px] !font-bold bg-white border-[1px] border-[#9A9A9A] mt-[20px]"
          onClick={() => {
            dialogRef.current?.open({
              mode: 'prompt',
            });
        ...
        >
          <span className="text-[14px]">Link prompt</span>
        </button>
      </div>

      <EditSuppliersDialog ref={dialogRef} type="create" />
    </>
  );
};
