...
const TransactionDetailModal = memo(
  ({ open, data, onOpenChange, onSubmitEnd }: TransactionDetailModalProps) => {
      ...
      <Dialog open={open} onOpenChange={toggleDialog}>
        ...
        >
          ...
          <div className="w-full overflow-hidden">
            ...
            <div className="w-full flex justify-between items-center">
              <div>Đặt cọc (20%)</div>
              <div className="font-bold text-red">{data?.deposit} đ</div>
            </div>
            <Divider />
          ...
          <DialogFooter className="flex-grow flex flex-row gap-4 !items-end !justify-center">
            ...
            <Show when={canConfirm}>
              <TransactionConfirmModal data={data} onSubmitEnd={onSubmitEnd}>
